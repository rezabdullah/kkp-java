 ...
 * @author rezabdullah
 */
public class PaymentPaidReport extends javax.swing.JFrame {
    ...
    /**
     * Creates new form PaymentPaidReport
     */
    public PaymentPaidReport() {
        initComponents();
        showData();
    }
    ...
    private void initComponents() {
        ...
        labelAdminTitle1.setText("LAPORAN PEMBAYARAN LUNAS");
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        try {
            JasperPrint jp = JasperFillManager.fillReport(getClass().getResourceAsStream("paymentPaidReport.jasper"), null, Database.ConnectDB());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaymentPaidReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
